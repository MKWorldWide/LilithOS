#!/usr/bin/env python3
"""
LilithOS Control Tool (lilithctl)

A command-line interface for managing and interacting with LilithOS components,
including the DivineBus integration with AthenaCore.
"""
...
try:
    from core.divine_bus import DivineBus
except ImportError as e:
    logger.error(f"Failed to import DivineBus: {e}")
    logger.error(f"Python path: {sys.path}")
    logger.error("Please ensure you're running from the LilithOS root directory")
    sys.exit(1)
